...
const ISSUE_KEYS: Record<AuditIssueCode, MessageKey> = {
  ...
  "missing-project-asset": "audit.issue.missingProjectAsset",
  "missing-color-token": "audit.issue.missingColorToken",
  "missing-text-style-token": "audit.issue.missingTextStyleToken",
  "detached-color-token": "audit.issue.detachedColorToken",
  "detached-text-style": "audit.issue.detachedTextStyle",
  ...
  "empty-guide-section": "audit.issue.emptyGuideSection",
  "incompatible-page-template": "audit.issue.incompatiblePageTemplate",
